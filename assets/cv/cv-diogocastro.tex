...
\cvitem{}{
  ...
  do ocasional presentations at work and aim to do more public speaking.
  \para
...
\cventry{Nov 2017-Present}{Senior Software Engineer}{SpotX}{Belfast, UK}{}{
  Developed RESTful web services in Scala, using the \code{cats} framework and Akka HTTP, deployed using Docker.%
  \para
  Worked on a service that aimed to augment Apache Druid, a timeseries database, with features such as
  access control, a simpler and safer query DSL, and automatic conversion of monetary
...
\cventry{May 2013-Jun 2014}{Software Engineer}{NantHealth}{Belfast, UK}{}{
  ...
  \begin{itemize}
    \item RESTful APIs, using ASP.NET Web API, ActiveMQ and Couchbase, Bootstrap,
...
\cvitem{Frameworks}{
  Yesod, Akka HTTP, ASP.NET, Angular, WinRT, ScalaCheck/QuickCheck/Hedgehog
}
\cvitem{Tools}{

...
\cventry{Jan 2019}{The Haskell Epidemic}{The Crystal Ball BASH, Belfast}{}{}{
  \barelink{https://talks.diogocastro.com/the-haskell-epidemic/}
  \para
  A presentation about Haskell's most influential features and how Haskell has shaped the software engineering landscape.
}


\section{Open Source}
\project{haskell-flatbuffers}{https://github.com/dcastro/haskell-flatbuffers}{
  Work in progress. Haskell implementation of FlatBuffers, a protocol for memory efficient
  serialisation, originally designed by Google.
}
\project{safe-buffer-monad}{https://hackage.haskell.org/package/safe-buffer-monad}{
  An mtl-style typeclass that models a monadic buffer resilient to exceptions,
  written in Haskell.
  If an exception is thrown, the user will still be able to proccess the contents of the
  buffer up to the point where the computation was interrupted.
}
